...
namespace Practica1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int valorNum = Convert.ToInt32(Console.ReadLine());
            //Console.WriteLine("El número que ingreso es: {0}", valorNum);
            ...
            //int numint = 777;
            //byte numero = (byte)numint;

            //string txtnum = "10";
            //int numint2 = int.Parse(txtnum);

            //string txtnum1 = "147";
            //int numint3 = Convert.ToInt32(txtnum1);

            //int numint4 = 74;
            //byte numbyte = Convert.ToByte(numint4);

            //long numlong = 6699;
            //int numint5 = (int)numlong;
